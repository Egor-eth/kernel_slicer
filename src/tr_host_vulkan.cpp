...
static const std::filesystem::path templates_path(kslicer::_templates_path);
...
void kslicer::VulkanCodeGen::GenerateHost(std::string fullSuffix, nlohmann::json jsonHost, kslicer::MainClassInfo& a_mainClass, const kslicer::TextGenSettings& a_settings)
{
  ...
  kslicer::ApplyJsonToTemplate(templates_path / "vk_class.h",        fullSuffix + ".h", jsonHost);
  kslicer::ApplyJsonToTemplate(templates_path / "vk_class.cpp",      fullSuffix + ".cpp", jsonHost);
  kslicer::ApplyJsonToTemplate(templates_path / "vk_class_ds.cpp",   fullSuffix + "_ds.cpp", jsonHost);
  kslicer::ApplyJsonToTemplate(templates_path / "vk_class_init.cpp", fullSuffix + "_init.cpp", jsonHost);
  if(a_settings.genSeparateGPUAPI)
    kslicer::ApplyJsonToTemplate(templates_path / "vk_class_api.h",  fullSuffix + "_api.h", jsonHost);
}
